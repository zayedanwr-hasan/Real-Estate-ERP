...
class RealEstateApp:
    def __init__(self, root: tb.Window):
        ...
        self.report_sections = {
            "تقارير العملاء والموردين": ["كشف حساب تفصيلي", "أرصدة الموردين/عقار", "أرصدة العملاء"],
            "تقارير الصناديق والبنوك": ["كشف حركة صندوق", "ملخص حركة الصناديق"],
            "تقارير العقارات": ["حالة العقارات (الأراضي)", "إيرادات ومصروفات عقار"],
            "التقارير المالية والدليل": ["طباعة دليل الحسابات", "ميزان المراجعة", "دفتر اليومية العامة"],
        }
